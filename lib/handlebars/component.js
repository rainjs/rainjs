...
/**
 * This Handlebars helper aggregate child components into the parent.
 ...
 * </div>
 * @example
 * Aggregates the view ``index`` of the component ``textbox`` with the latest version and set the static id ``button1``
 * <div class="template">
