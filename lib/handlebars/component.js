 ...
 * Complete syntax:
 *
 * {{component name="componentId" version="versionNumber" view="viewID" sid="staticId"
 * data="templateData" placeholder=true}}
 *
 * @example
 ...
 *
 * @example
 *      Aggregates the view ``help`` from the parent component and populates the custom data
 *      to the aggregated component.
 *
 *      <div class="template">
 ...
 * @example
 *      Aggregates the view ``help`` from the parent component and populates the custom data
 *      to the aggregated component but doesn't load the placeholder.
 *
 *      <div class="template">
