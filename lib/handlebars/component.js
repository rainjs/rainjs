 ...
 * Complete syntax::
 *
 *      {{component view="viewID" [name="componentId" [version="versionNumber"]] [sid="staticId"] [placeholder=true]}}
 *
 * @example
...
ComponentHelper.prototype.helper = function (options) {
     ...
     * check valid view
     */
    if(!renderer.isValidView(childComponent)){
     ...
     * check authorization
     */
    if (!renderer.isAuthorized(childComponent, renderer.AUTHORIZATION_TYPE_VIEW)) {
