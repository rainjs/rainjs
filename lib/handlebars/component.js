...
var render_util = require('../render_utils');
 ...
 *
 * Complete syntax:
 *      {{component name="compnentId" version="versionNumber" view="viewID" sid="staticId" placeholder=true customAttr=value }}
 * </pre>
 * @example
 ...
 *
 * @example
 *      Aggregates the view ``help`` from the parent component but dosn't load the placeholder.
 *
 *      <div class="template">
...
ComponentHelper.prototype.helper = function (options) {
     ...
     * check valid view
     */
    if(!render_util.isValidView(childComponent, renderer.rain)){
     ...
     * check authorization
     */
    if (!render_util.isAuthorized(childComponent, render_util.AUTHORIZATION_TYPE_VIEW)) {
        render_util.replaceWithError(401, childComponent,
