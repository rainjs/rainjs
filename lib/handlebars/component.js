 ...
 * The helper invokes the renderer to load custom data from the data layer for the template and calls the
 * rendering process after the data is received, to render the component.
 *
 * <pre>
 * Complete syntax:
 *      {{component name="compnentId" version="versionNumber" view="viewID" sid="staticId" data="templateData" placeholder=true}}
 * </pre>
 * @example
 ...
 * </div>
 * @example
 * Aggregates the view ``help`` from the parent component and populates the custom data to the aggregated component but dosn't load the palceholder.
 * <div class="template">
 *     {{component view="help" data=templateData placeholder=false}}
 * </div>
 *
