...
/**
 * Class that handless the registration and handling of user defined intents.
 *
 * @constructor
 */
        ...
        switch (response.type) {
            ...
            case 'server':
                try {
                    ...
                    throw new RainError('Could not require controller for server intent ' + intent.category + '.' + intent.action + '.');
                }
...
/**
 * Resolves an intent recived from a user.
 *
