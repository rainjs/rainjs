 ...
 * @returns {Object} the tag lib entry for the exception
 */
ExceptionHandler.prototype.renderException = function (statusCode, exception) {
    ...
    // Construct the module string for the exception component
    ...
    return {
        namespace: '',
        selector: [this.component.module, statusCode].join('_'),
        module: module,
...
function logException(exception, statusCode) {
    ...
    if (exception.stack) {
        ...
        mod_logger.error(exception.message);
    }
}
