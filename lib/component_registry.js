 ...
 * @memberOf ComponentRegistry
 */
var plugins = ['precompiler.js'];

/**
 * Registers the components, holds their configuration and expose an interface to obtain
 ...
 *
 * @param {ComponentRegistry} self the class instance
 * @private
 * @memberOf ComponentRegistry#
 */
