 ...
 * @memberOf ComponentRegistry
 */
var plugins = ['precompile_templates.js', 'precompile_less', 'websockets.js', 'intents'];
...
function registerPlugins() {
    for (var i = plugins.length; i--;) {
        try {
            ...
            throw new RainError('Registry Plugin ' + plugins[i] + 'is invalid.', ex, RainError.ERR_IO);
        }
    }
}
