...
LayerData.prototype.loadData = function(componentOpt, callback) {
     ...
     */
    var component = server.componentRegistry.getConfig(componentOpt.id, componentOpt.version);
    if (!component) {
     ...
     * 2. require data.js
     */
    var absoluteDataPath = path.join(server.config.server.componentPath, componentOpt.id, this.dataPath);
