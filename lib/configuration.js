 ...
 * @constructor
 */
module.exports = function Configuration(configPath) {
    if (!configPath) {
...
function load(self) {
    ...
    try {
        ...
        throw new Error('The server configuration file doesn\'t exist!');
    }
    ...
    try {
        ...
        throw new Error('The server configuration file doesn\'t contain valid JSON!')
    }
}
