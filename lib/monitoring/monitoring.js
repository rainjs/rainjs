...
Monitoring.prototype._resetData = function (step) {
    for (var i in this._measurementMap) {
        if(this._measurementMap[i].type === 'time' && this._measurementMap[i].step === step) {
 ...
 * @private
 */
Monitoring.prototype._increment = function (configKey) {
 ...
 * @private
 */
Monitoring.prototype._decrement = function (configKey) {
    this._measurementMap[configKey].measurements.total --;
}
...
Monitoring.prototype._average = function (configKey) {
    var measurements = this._measurementMap[configKey].measurements;
    return measurements.total/measurements.requests;
}
