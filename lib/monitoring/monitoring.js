...
Monitoring.prototype.startMeasurement = function (configKey, id) {
    ...
    if (!configKey) {
        throw new RainError('You must always pass the configuration key of the use case',
...
Monitoring.prototype.registerEvent = function (configKey) {
    ...
    if (this._measurementMap[configKey].operation === 'count') {
       ...
       this._measurementMap[configKey].measurements.activeRequests ++;
    }
...
Monitoring.prototype._setIntervalSending = function () {
    var self = this;
