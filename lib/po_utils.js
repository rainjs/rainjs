...
function parsePo(data) {
    ...
    if (errors.length) {
        console.log("Errors parsing po file:\n" + errors.join("\n"));
    }
...
function generateContext(component) {
    return {
        nt: function (msgid, msgidPlural, count, args) {
            return translation.translate(component, msgid, msgidPlural, count, args);
        },
        t: function (msgid, args) {
            return translation.translate(component, msgid, undefined, undefined, args);
        }
    };
};
